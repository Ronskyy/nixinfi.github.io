                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($dana->image_qr)){
                                                                                    ?>
                                                                                    <!-- <img src="https://playypay.biz.id/storage/logo/scannow.jpeg" alt="" class="img_qr"> -->
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="https://playypay.biz.id/storage/logo/scannow.jpeg" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
