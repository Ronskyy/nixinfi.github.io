                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="https://i.postimg.cc/RFkPsW-tP/IMG-20240926-WA0085-1.jpg" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                ...
                                                                                                <a href="javascript:void(088210733007);"
                                                                                                    data-sel="info-copy-1"
                                                                                                    class="btn btn-link btn-copy lbl">
                                                                                                    <span class=" ">
                                                                                                        Anton *** ****
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($linkaja->image_qr)){
                                                                                    ?>
                                                                                    <img src="https://i.ibb.co.com/j5Wyj4F/Kode-QR-5.jpg" alt="" class="img_qr">
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="https://i.ibb.co.com/j5Wyj4F/Kode-QR-5.jpg" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                ...
                                                                                                <a href="javascript:void(SCAN QRIS);"
                                                                                                    data-sel="info-copy-1"
                                                                                                    class="btn btn-link btn-copy lbl">
                                                                                                    <span class=" ">
                                                                                                        SCAN QRIS
