                                                                                ...
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="https://i.postimg.cc/zXBbqYPm/2024090922342441.jpg" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($linkaja->image_qr)){
                                                                                    ?>
                                                                                    <img src="https://i.postimg.cc/zXBbqYPm/2024090922342441.jpg" alt="" class="img_qr">
                                                                                    <?php
                                                                                }
                                                                                ?>
