...
@section('content')
                                ...
                                <div class="col-xs-12 col-md-8 content-form">
                                                        ...
                                                        <form id="depositForm" class="needs-validation"
                                                            ...
                                                            <div class="box-wrapper plr-15">
                                                                ...
                                                                <div class="tab">
                                                                    ...
                                                                    <div class="row d-flex"><div class="col-md-3 col-xs-4  ">
                                                                            <div class="font-weight-bold">
                                                                                Bank Penerima<span
                                                                                    class="text-danger">*</span>
                                                                            </div>
                                                                                        ...
                                                                                        <tr class=" ">
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                <input id="info-copy-2"
                                                                                                    value="{{ $bca->no_rek }}"class="copy-input" />
                                                                    ...
                                                                    <div class="row d-flex">
                                                                        ...
                                                                        <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                            <select
                                                                                ...
                                                                                data-plugin="bank_list" id="bank_name_5"
                                                                                name="bank_name">
                                                                                <option selectedvalue="{{ $mandiri->nama_bank . ' - ' . $mandiri->nama_penerima }}">
                                                                ...
                                                                <div class="tab">
                                                                        ...
                                                                        <div class="col-xs-12 col-md-9 ">
                                                                            <div class="bankInfo-box" id="bankList">
                                                                                ...
                                                                                if(!empty($dana->image_qr)){
                                                                                    ?>
                                                                                    <!-- <img src="https://i.postimg.cc/pT3qpB51/Screenshot-20240907-123527.jpg" alt="" class="img_qr"> -->
                                                                                    <?php
                                                                                }
                                                                                ?>
                                                                                <table
                                                                                    ...
                                                                                    <tbody>
                                                                                        <td colspan="2" style="padding-bottom:10px">
                                                                                            <img src="https://i.postimg.cc/pT3qpB51/Screenshot-20240907-123527.jpg" alt="" style="display:block; margin:auto; height: 200px;">
                                                                                        </td>
                                                                                        <tr class="text-left first">
                                                                                            <td class="col-xs-12 col-md-6 "
                                                                                                colspan="2">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                style="padding-bottom: 10px;">
                                                                                                <input id="info-copy-2"
                                                                                                    value="8205506752"class="copy-input">
                                                                    ...
                                                                    <div class="row d-flex">
                                                                        <div class="col-md-3 col-xs-4">
                                                                            <div class="font-weight-bold">
                                                                                Bonus </div>
                                                                        </div><div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                            <div class="m-15" style="width: 100%;">
                                                                                <div style="width: 100%;">
                                                                                    <select class="form-control promoList"
                                                                                         id="pilih_promo_dana" 
                                                                    ...
                                                                    <div class="row d-flex">
                                                                        ...
                                                                        <div class="col-md-9 col-xs-8 d-flex flex-wrap">
                                                                            <div class="file-drop-area m-15">
                                                                                <span class="btn btn-secondary "
                                                                                    i18n="">Pilih File</span>
                                                                                <span class="file-msg">atau seret dan taruh file di sini
                                                                                </span>
                                                                                <input class="file-input"
                                                                                    name="bukti_transfer" 
                                                                                    id="receipt" type="file"
                                                                                        ...
                                                                                        <tr>
                                                                                            <td class="col-xs-12 col-md-6"
                                                                                                ...
                                                                                                <a href="javascript:void(0);"
                                                                                                    ...
                                                                                                    class="btn btn-link btn-copy lbl">
                                                                                                    <span
                                                                                                        style="white-space: normal; word-break: break-word;">{{ $linkaja->no_rek }}
                                                                                                    </span>
                                                                                                    <i
                                                                                                        class="icon-copy"></i>
                                                                                                </a>
                                                                        ...
                                                                        <div class="col-md-12 d-flex flex-wrap">
                                                                            <label>
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    name="termcondition">
                                                                                Saya telah membaca dan menyetujui Syarat dan
                                                                                Ketentuan Promosi. Kami tidak menerima jenissetoran dalam bentuk cek. Semua jenis
                                                                                pembayaran
                                                                                dalam bentuk cek ke akun kami akan
                                                                                diabaikan.
                                                                            </label>
                                                                                    ...
                                                                                    <select class="form-control promoList"
                                                                                        ...
                                                                                        @foreach ($bonus as $b)
                                                                                            <option
                                                                                                ...
                                                                                                <!--  data-min="@currency($b->minimal)"
                                                                                                data-minin="{{ $b->minimal }}"
                                                                                                    Minimal Transaksi:@currency($b->minimal) -->
                                                                                            </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
                                    ...
                                    <script>
                                        ...
                                        function btn_linkaja() {
                                            document.getElementById('modal_linkaja').style.display = "block";document.getElementById('metode').style.display = "none";
                                        }
                        ...
                        <div class="acc_safety_info box-wrapper deposit-notice-wraper">
                            <div class="deposit-notice-content">
                                ...
                                <ol>
                                    ...
                                    <li><span style="font-weight: bolder;">Untuk deposit, wajib menggunakan kode unik agar terproses.</span></li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            //     prefix: '',
            //     centsLimit: 0,
            //     thousandsSeparator: ',',//     clearOnEmpty: true
            // });
        });
