...
<body class="mobile">
    <div class="full-container layout">
        ...
        <div id="floating_banner_bottom" style="background:transparent;bottom: 80px; height: auto; left: 0px; padding: 2px 2px 2px 2px; position: fixed; text-align: center; width: auto; z-index: 1001;">
<div class="closebutton" style="color: #fff; font-weight: bold;left: 2px;opacity: 0.98;background-color: #c30025;cursor: pointer;padding: 5px 20px;border-top-right-radius: 5px;border-top-left-radius: 5px;">
<a style="color: white; text-decoration: none;" href="#" onclick="document.getElementById('floating_banner_bottom').style.display='none';return false;">X</a></div>

<div><a alt="QRIS"<a href="https://i.ibb.co.com/QYJD44N/IMG-20241006-WA0045-21.jpg""https://i.ibb.co.com/rpQCsRh/Whats-App-Image-2024-10-25-at-12-47-58.jpg" ><img alt="QRIS" border="0" height="55" src="https://res.cloudinary.com/dilmoaqjt/image/upload/v1715622029/qristempur777_edq8xe.gif" title="QRIS" width="55"></a></div>
<div><a alt="ETSXOG" href="" title="ETSXOG" target="_blank"><img alt="ETSXOG" border="0" height="55" src="https://files.sitestatic.net/ImageFile/fctz8Jflz39CfBoU7i9jIzZtcffVKNfatevbmdek.gif" title="ETSXOG" width="55"></a></div>
<div><a alt="ETSXOG" <a="" href="https://akademik.sdn36pekanbaru.sch.id/spbo/" target="_blank" rel="noopener"><img style="border-radius:15px" class="apkdownload" src="https://wonderfull88.cwhonors.org/gmbr/side-livescore.gif" alt="INFO RTP" width="65" height="65"></a></div>
<div><a alt="ETSXOG" href="" title="ETSXOG" target="_blank"><img alt="ETSXOG" border="0" height="55" src="https://files.sitestatic.net/ImageFile/202406012102430000006010945c1ePABAAA9__180x180.gif" title="ETSXOG" width="55"></a></div>
</div>
<div class="closebutton" style="color: #fff; font-weight: bold;left: 2px;opacity: 0.98;background-color: #c30025;cursor: pointer;padding: 5px 20px;border-top-right-radius: 5px;border-top-left-radius: 5px;">
<a style="color: white; text-decoration: none;" href="#" onclick="document.getElementById('floating_banner_bottom').style.display='none';return false;">X</a></div>
    <div class="full-container layout">
